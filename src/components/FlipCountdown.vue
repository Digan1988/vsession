<template>
  <div class="container flip-clock">
    <template v-bind:key="data.label" v-for="data in timeData" v-show="show">
      <span  class="flip-clock__piece" :id="data.elementId" v-show="data.show">
        <span class="flip-clock__card flip-card">
          <b class="flip-card__top">{{ twoDigits(data.current) }}</b>
          <b class="flip-card__bottom" v-bind:data-value="twoDigits(data.current)"></b>
          <b class="flip-card__back" v-bind:data-value="twoDigits(data.previous)"></b>
          <b class="flip-card__back-bottom" v-bind:data-value="twoDigits(data.previous)"></b>
        </span>
